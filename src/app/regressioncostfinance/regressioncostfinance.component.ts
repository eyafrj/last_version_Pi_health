...
@Component({
  selector: 'app-regressioncostfinance',
  templateUrl: './regressioncostfinance.component.html',
  styleUrls: ['./regressioncostfinance.component.css']
})
export class RegressioncostfinanceComponent {
