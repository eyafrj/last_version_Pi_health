...
@Component({
  selector: 'app-predict-regressionstaff',
  templateUrl: './predict-regressionstaff.component.html',
  styleUrls: ['./predict-regressionstaff.component.css']
})
export class PredictRegressionstaffComponent {
